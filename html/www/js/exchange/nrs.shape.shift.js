...
var NRS = (function(NRS, $) {
        ...
        apiCall('recenttx/50', {}, 'GET', function (data) {
            ...
            if (data) {
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (String(transaction.curIn).escapeHTML() != "GALA" && String(transaction.curOut).escapeHTML() != "GALA") {
                        continue;
                    }
                    rows += "<tr>";
        ...
        apiCall('getcoins', {}, 'GET', function (data) {
            ...
            for (var i = 0; i < inputFields.length; i++) {
                ...
                $.each(data, function (code, coin) {
                    if (code != 'GALA' && coin['status'] == 'available') {
    ...
    $("#shape_shift_buy_modal").on("show.bs.modal", function (e) {
        ...
        $("#shape_shift_buy_min_coin").html("GALA");
        $("#shape_shift_buy_max").val(invoker.data("max"));
        $("#shape_shift_buy_max_coin").html("GALA");
        $("#shape_shift_buy_rate").val(invoker.data("rate"));
        $("#shape_shift_buy_rate_text").html("GALA/" + coin);
    ...
    $("#m_send_amount_buy_modal").on("show.bs.modal", function (e) {
        ...
        $("#m_send_amount_buy_rate_text").html("GALA/" + coin);
    ...
    $('#m_send_amount_buy_withdrawal_amount, #m_send_amount_buy_withdrawal_address').change(function () {
        ...
        apiCall('sendamount', {
            ...
            try {
                ...
                // add 1 GALA fee to make sure the net amount is what requested by shape shift
    ...
    $("#shape_shift_sell_modal").on("show.bs.modal", function (e) {
        ...
        async.waterfall([
            ...
            function(callback) {
                ...
                $("#shape_shift_sell_rate_text").html(coin + "/GALA");
                $("#shape_shift_sell_fee").val(data.fee);
                $("#shape_shift_sell_fee_coin").html("GALA");
    ...
    $("#m_send_amount_sell_modal").on("show.bs.modal", function (e) {
        ...
        $("#m_send_amount_sell_rate_text").html("GALA/" + coin);
        $("#m_send_amount_sell_fee_coin").html("GALA");
        $("#m_send_amount_sell_withdrawal_amount_coin").html("GALA");
