...
### Usable URLs ###
  ...
  - **API** - http://localhost:7003/test
  - **DB Interface** - http://localhost:7003/dbshell
  - **Java Class Browser** - http://localhost:7003/doc
...
### Testing ###
  ...
  - all API calls can be tested manually from the auto-generated http://localhost:7003/test page
